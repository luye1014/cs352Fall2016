...
// void printSummary(Node **head, char*cmdNum1, char*cmdNum2){
//   // printf("%s %s\n",cmdNum2, cmdNum1 );
//   // printList(head);
//   int count = 0;
//   Node *cur = *head;
...
// void printYONSummary(Node **head, char*cmdNum1, char*cmdNum2){
//   int flag = 0;
...
//       // else if(strcmp(cur->value, cmdNum1)==0||strcmp(cur->cNode->value, cmdNum1)==0){
//       //  if(strcmp(cur->cNode->value, cmdNum2)!=0 && strcmp(cur->cNode->value, cmdNum1)!=0){
//       //    insert(&numersList, cur->cNode->value);
//       //  }else if(strcmp(cur->cNode->value, cmdNum2)!=0){
//       //    insert(&numersList, cur->value);
//       //  } 
//       // }
//       // else if(strcmp(cur->value, cmdNum2)==0||strcmp(cur->cNode->value, cmdNum2)==0){
//       //  if(strcmp(cur->cNode->value, cmdNum2)!=0 && strcmp(cur->cNode->value, cmdNum1)!=0){
//       //    insert(&numersList2, cur->cNode->value);
//       //  }else if(strcmp(cur->cNode->value, cmdNum1)!=0){
//       //    insert(&numersList2, cur->value);
...
// // void insertIntoList(Node **head, char *data, char* linkedObj){
// //   Node *newNode = malloc(sizeof(Node));
// //   if (newNode == NULL){
// //     perror("Failed to allocate a new node for the linked list");
// //     exit(1);
...
//     }
//     //printList(head);
//     //if the command line numers are same
//     if(strcmp(argv[i],argv[i+1])==0){
//       printf("0\nno\n");
//       return 0;
//     }
//     printSummary(&head, argv[i], argv[i+1]);
//     printYONSummary(&head, argv[i], argv[i+1]);
//     // printf("%s\n", argv[i]);
//     // printf("%s\n", argv[i+1]);
//   }
//   return 0;
