 ...
 *
 * But, if you're curious, what it does is to first sleep for N seconds
 * (where N is argv[1]), and then it connects to http://www.cs.arizona.edu/
 * and downloads the root index page.  The page is printed to stdout.
 */
